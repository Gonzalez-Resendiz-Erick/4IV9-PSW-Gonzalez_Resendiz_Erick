...
<html>
    ...
    <body>
        <%
            ...
            try{
                ...
                try{
                    ...
                    String q = "delete from registro_producto where id_usu="+id;
        ...
        <br>
        <a href="administracion.html" >Regresar al Menú Principal</a>
        <br>
        <a href="registrar.jsp" >Registrar Nuevo Producto</a>
