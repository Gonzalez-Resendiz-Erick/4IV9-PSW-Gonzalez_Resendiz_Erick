...
<html>
    ...
    <body>
        ...
        <form method="post" name="formularioactualizar"  action="actualizar_promocion.jsp">
            <table border="2" >
                <%
                    Connection con = null;
                    Statement set = null;
                    ...
                    try{
                        ...
                        try{
                            ...
                            String q = "select id_usu, tipo_usu, gramos_usu, tamaño_usu, envase_usu, precio_usu, descuento_usu from registro_promocion "
                                    + "where id_usu="+id;
